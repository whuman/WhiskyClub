CREATE TABLE [dbo].[TastingNote] (
	...
	CONSTRAINT [FK_TastingNote_Event] FOREIGN KEY ([EventId]) REFERENCES [dbo].[Event] ([EventId])
);
...
GO
CREATE NONCLUSTERED INDEX [IX_FK_TastingNote_Event]
	ON [dbo].[TastingNote]([EventId] ASC);
